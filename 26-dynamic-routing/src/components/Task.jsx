...
function Task({task}) {
  const {dispath,setSelectedTask} = useContext(TaskContext)
  ...
  return (
    <div  className='flex flex-col border bg-white m-2 shadow-lg w-[20rem] gap-3 rounded-lg z-10 '>
      ...
      <div className='flex items-center justify-between m-2'>
        <button onClick={selectTask} className='bg-green-600 hover:bg-green-700 px-6 py-2 text-white rounded-lg'>
        <FaRegEdit />
        </button>
