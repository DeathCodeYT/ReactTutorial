  ...
  return (
    <nav className='flex items-center justify-between bg-slate-800 p-2'>
      ...
      <div className='flex items-center gap-10 text-white'>
        ...
        <NavLink className={({isActive})=>`hover:text-blue-600 ${isActive&&"text-blue-500"}`} to='/tasks'>Tasks</NavLink>
        ...
        <NavLink className={({isActive})=>`hover:text-blue-600 ${isActive&&"text-blue-500"}`} to='/name/EnterNameHere'>Name</NavLink>
      </div>
